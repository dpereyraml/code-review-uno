...
var (
	// ErrVehicleNotFound is an error that is used when the Vehicle is not found
	ErrVehicleNotFound = errors.New("Vehicle not found")
	// ErrVehicleDuplicate is an error that is used when the Vehicle already exists
	ErrVehicleDuplicated = errors.New("Vehicle already exists")
	// ErrVehicleInvalidField is an error that is used when the Vehicle is invalid
	ErrVehicleInvalidField = errors.New("Vehicle is invalid")
	// ErrVehicleInternal is an error that is used when the Vehicle can't be saved
	ErrVehicleInternal = errors.New("Vehicle can't be processed")
)
